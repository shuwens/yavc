...
api.nvim_set_keymap('n', 'gn', '<cmd>lua vim.diagnostic.goto_next(got_opts)<CR>', opts)
api.nvim_set_keymap('n', '<C-j>', '<cmd>lua vim.diagnostic.goto_next(goto_opts)<CR>', opts)
api.nvim_set_keymap('n', '<C-k>', '<cmd>lua vim.diagnostic.goto_prev(goto_opts)<CR>', opts)
